...
class PlaylistPage extends StatelessWidget {
  build(BuildContext context) {
    return Scaffold(
        backgroundColor: Colors.transparent, body: StatePlaylistPage());
  }
}

class StatePlaylistPage extends StatefulWidget {
  createState() => _StatePlaylistPage();
}
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Container(
              ...
              alignment: Alignment.centerLeft,
              margin: EdgeInsets.only(left: 15, right: 10, top: 20, bottom: 10),
            ),
            Padding(
